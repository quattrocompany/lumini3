...
// Imagens de exemplo da galeria do Lumini 3
const galeriaImagens = [
  { src: "/img/lumini3/01.jpg", title: "Fachada Residencial", data: "2026-08-07" },
  { src: "/img/lumini3/02.jpg", title: "Portaria e Acesso", data: "2026-08-07" },
  { src: "/img/lumini3/03.jpg", title: "Piscina e Solário", data: "2026-08-07" },
  { src: "/img/lumini3/04.jpg", title: "Espaço Gourmet", data: "2026-08-07" },
  { src: "/img/lumini3/05.jpg", title: "Academia Fitness", data: "2026-08-01" },
  { src: "/img/lumini3/06.jpg", title: "Salão de Festas", data: "2026-08-01" },
  { src: "/img/lumini3/07.jpg", title: "Brinquedoteca", data: "2026-08-01" },
  { src: "/img/lumini3/08.jpg", title: "Coworking", data: "2026-08-01" },
];

export default function KitCorretorLuminiPage() {
      ...
      <div>
        ...
        <div className="max-w-[1200px] mx-auto px-6 py-12">
          ...
          <div className="mb-10 text-center bg-white p-8 rounded-2xl shadow-sm border border-gray-200 max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <a
              href="/downloads/kit-lumini3.zip"
              download
          ...
          <div className="mb-12 text-center">
            <h1 className="text-3xl md:text-5xl font-black text-[#1E293B] uppercase tracking-tight mb-4">
              Kit Corretor - Lumini 3
            </h1>
            <p className="text-gray-600 text-base max-w-2xl mx-auto">
              Escolha abaixo os materiais oficiais para enviar aos seus clientes e postar nas redes sociais.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition-shadow flex flex-col items-center text-center">
              ...
              <button className="w-full bg-[#1E293B] text-white font-bold py-3 rounded-full hover:bg-[#0f172a] transition-colors text-sm cursor-pointer">
          ...
          {/* GALERIA DE IMAGENS AVULSAS COM FILTRO */}
      ...
      <div className="w-full bg-[#1E293B] pt-12 md:pt-16 text-white mt-16 md:mt-24">
        <div className="max-w-[1200px] mx-auto px-6 flex flex-col items-center justify-center gap-6 mb-8">
          ...
          <div className="flex items-center justify-center gap-5">
            {/* Instagram */}
            <a 
              href="https://www.instagram.com/lumini3/" 
              target="_blank" 
              rel="noopener noreferrer"
              aria-label="Instagram Lumini 3"
            ...
            {/* Facebook */}
            <a 
              href="https://www.facebook.com/lumini3/" 
              target="_blank" 
              rel="noopener noreferrer"
              aria-label="Facebook Lumini 3"
              className="w-12 h-12 bg-white/10 hover:bg-[#DD6810] rounded-full flex items-center justify-center transition-all transform hover:scale-110 shadow-md border border-white/20"
            >
              <svg className="w-6 h-6 fill-current text-white" viewBox="0 0 24 24">
