...
// Array configurável das fotos da Seção Lazer
const imagensLazer: ItemLazer[] = [
  {
    src: "/img/pet place.jpg", // Substitua pelos caminhos reais das fotos em public/img/
    titulo: "PET PLACE",
    alt: "Espaço Pet Place para seu animal de estimação",
  },
  {
    src: "/img/playground.jpg",
    titulo: "PLAYGROUND",
    alt: "Área de playground para crianças",
  },
  {
    src: "/img/espaco grill.jpg",
    titulo: "ESPAÇO GRILL COM CHURRASQUEIRA",
    alt: "Espaço grill com churrasqueira",
  },
  {
    src: "/img/piscina infantil.jpg",
    titulo: "PISCINA INFANTIL",
    alt: "Piscina infantil com área de descanso",
  },
    {
    src: "/img/crossfit.jpg",
    titulo: "CROSSFIT",
    alt: "Área de crossfit para atividades físicas",
  },
    {
    src: "/img/voo do lazer.jpg",
    titulo: "VOO DO LAZER",
    alt: "Área de voo do lazer para atividades recreativas",
  },
    {
    src: "/img/piscina adulto deck molhado.jpg",
    titulo: "PISCINA ADULTO DECK MOLHADO",
    alt: "Piscina para adultos com deck molhado",
  },
    {
    src: "/img/quadra de beach volei.jpg",
    titulo: "QUADRA DE BEACH VOLEI",
    alt: "Quadra de beach volei para atividades esportivas",
  },
    {
    src: "/img/voo do lazer piscina.jpg",
    titulo: "VÔO DO LAZER PISCINA",
    alt: "Área de voo do lazer da piscina para atividades recreativas",
  },
    {
    src: "/img/salao de festas.jpg",
    titulo: "SALÃO DE FESTAS",
    alt: "Salão de festas para eventos e comemorações",
  },
    {
    src: "/img/quadra poliesportiva.jpg",
    titulo: "QUADRA POLIESPORTIVA",
    alt: "Quadra poliesportiva para atividades físicas",
  },
    {
    src: "/img/espaco beleza.jpg",
    titulo: "ESPAÇO BELEZA",
    alt: "Espaço de beleza para tratamentos e cuidados",
  },
    {
    src: "/img/brinquedoteca.jpg",
    titulo: "BRINQUEDOTECA",
    alt: "Área de brinquedoteca para crianças",
  },
    {
    src: "/img/salao de jogos.jpg",
    titulo: "SALÃO DE JOGOS",
    alt: "Salão de jogos para entretenimento",
  },    
  {
    src: "/img/fitness.jpg",
    titulo: "FITNESS",
    alt: "Área de fitness para atividades físicas",
  },
];
    ...
    >
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          ...
          {/* Card Central da Imagem com Bordas Arredondadas */}
          <div className="w-full flex flex-col items-center">
            <div className="relative w-full aspect-[16/9] sm:aspect-[16/10] md:aspect-[16/9] rounded-[2rem] sm:rounded-[2.5rem] overflow-hidden shadow-2xl bg-black/20 border-4 border-white/10 flex flex-col justify-between">
              ...
              {/* Faixa Amarela/Laranja de Legenda na Base */}
