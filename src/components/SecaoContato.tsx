...
export default function SecaoContato() {
  return (
    <section id="contato" className="py-6 md:py-16 bg-white relative z-10 overflow-visible">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 overflow-visible">
        
        {/* Degradê corrigido: Azul no prédio (esquerda/baixo) e Laranja no formulário (direita/cima) */}
        <div className="relative bg-gradient-to-b from-[#FFBA00] via-[#FFBA00] via-20% to-[#87CEEB] to-60% lg:bg-gradient-to-r lg:from-[#87CEEB] lg:from-40% lg:via-[#FF9E00] lg:via-50% lg:to-[#FFBA00] lg:to-90% rounded-[2.5rem] shadow-xl flex flex-col lg:flex-row items-stretch justify-between lg:mt-1 overflow-visible">
          ...
          <div className="w-full lg:w-6/12 flex flex-col justify-center p-6 pb-2 sm:p-10 sm:pb-4 lg:p-12 xl:pr-16 xl:pl-8 z-10 order-1 lg:order-2">
            <h3 className="font-medium text-[#4A137B] text-xl sm:text-2xl lg:text-3xl uppercase leading-tight mb-6 drop-shadow-sm text-center lg:text-left">
              CADASTRE-SE E RECEBA EM 1ª MÃO<br/>TODAS AS INFORMAÇÕES:
            </h3>
