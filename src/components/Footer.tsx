    ...
    <>
      ...
      <div 
        className={`fixed bottom-0 left-0 w-full z-50 bg-[#6f469d] shadow-[0_-10px_30px_rgba(0,0,0,0.3)] transition-transform duration-500 ease-in-out ${
          showStickyBar ? "translate-y-0 rounded-t-3xl" : "translate-y-full"
        }`}
      >
        <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row items-stretch justify-center h-auto md:h-20 divide-y md:divide-y-0 md:divide-x divide-white/20">
          ...
          >
            ...
            <span className="text-xs sm:text-sm font-medium tracking-wider uppercase">Atendimento Telefônico</span>
          </a>
          ...
          >
            ...
            <span className="text-xs sm:text-sm font-medium tracking-wider uppercase">Fale pelo WhatsApp</span>
          </a>
          ...
          >
            ...
            <span className="text-xs sm:text-sm font-medium tracking-wider uppercase">Visite nosso estande</span>
          </a>
